...
public class WebViewPGsHandler implements HttpHandler {
    ...
    private List<String> fetchPGsFromDB(String partnerId) throws SQLException {
        ...
        String sql =
            ...
            "total_four_sharing_rooms, total_five_sharing_rooms, available_rooms, room_price, amenities, "
            + "rating, hotel_contact, status, pg_contact, status " +
